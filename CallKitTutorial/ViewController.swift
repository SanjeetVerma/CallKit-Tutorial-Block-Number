...
class ViewController: UIViewController {
    ...
    private func loadData() {
        ...
        let fetchRequest:NSFetchRequest<Caller> = self.callerData.fetchRequest(blocked: self.showBlocked) as! NSFetchRequest<Caller>
    ...
    @IBAction func reloadTapped(_ sender: UIButton) {
        ...
        print("reloadTapped called")
        CXCallDirectoryManager.sharedInstance.reloadExtension(withIdentifier: "com.ios.damsel.call", completionHandler: { (error) in
            if let error = error {
